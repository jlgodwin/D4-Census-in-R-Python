...
A hierarchy of U.S. Census Bureau geographic data can be found [here](https://www2.census.gov/geo/pdfs/reference/geodiagram.pdf).
...
Read in the HOLC spatial data and plot it according to neighborhood designation. Shreveport HOLC designations are found [here](https://dsl.richmond.edu/panorama/redlining/data).
```{r}
